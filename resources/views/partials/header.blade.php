                            ...
                            @if(auth()->user()->role === 'user')
                                <div class="dropdown">
                                    ...
                                    <a href="#"
                                        ...
                                        <img src="{{ auth()->user()->photo ?? 'https://github.com/mdo.png' }}" alt="" width="32"
                                                    ...
                                                    <form id="form4" class="form-group flex-wrap p-3">
                                                        <div class="form-input col-lg-12 my-4">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-9">
                                                                    <input type="text" id="exampleFullName" name="name"
                                                        ...
                                                        <div class="form-input col-lg-12 my-4">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-9">
                                                                    <input type="text" id="exampleAadharNumber"
                                                                        name="aadhar" placeholder="Enter Aadhar "
                                                                        class="form-control ps-3">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-input col-lg-12 my-4">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-9">
                                                                    <input type="text" id="exampleMobileNumber"
                                                        ...
                                                        <div class="form-input col-lg-12 my-4">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-9">
                                                                    <input type="text" id="exampleAddress"
                                                        ...
                                                        <div class="form-input col-lg-12 my-4">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-9">
                                                                    <input type="pincode" class="form-control"
                                                                        id="examplePincode" name="pincode"
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-4">
                                                                    <label for="ExamplePhoto"
                                                                        ...
                                                                        Photo</label>
                                                                    <input type="file" id="ExamplePhoto" name="image"
                                                                        class="form-control ps-3"
                                                                ...
                                                                <div class="col-lg-4">
                                                                    <label for="ExampleAadhar"
                                                                        class="form-label fs-6 text-uppercase fw-bold text-black">Aadhar
                                                                        Photo</label>
                                                                    <input type="file" id="ExampleAadhar"
                                                                        name="aadharImage" class="form-control ps-3"
                                                                ...
                                                                <div class="col-lg-4">
                                                                    <label for="ExamplePen"
                                                                        ...
                                                                        Photo</label>
                                                                    <input type="file" id="ExamplePen" name="panImage"
                                                                        class="form-control ps-3"
                                                        ...
                                                        <label class="py-3">
                                                            <input type="checkbox" required class="d-inline">
                                                            <span class="label-body text-black">I agree to the <a
                                                                    href="#" class="text-black border-bottom">Privacy
                                                                    Policy</a></span>
                                                        </label>
                                                        <div class="d-grid my-3">
                                                            <button
